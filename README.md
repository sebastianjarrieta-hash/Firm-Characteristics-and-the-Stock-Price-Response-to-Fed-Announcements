...
Leverage's explanatory role is weak once cyclicality and Q are accounted for; firm size and bid-ask spread are included as controls rather than primary channelsuction and regression analysis, run in Google Colab · LaTeX (Overleaf) for tables and writeup
